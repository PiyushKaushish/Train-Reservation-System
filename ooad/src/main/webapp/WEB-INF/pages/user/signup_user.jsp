	...
	<div class="tab green">
		<div class="signup-form">
			<form
				...
				<h2>Register</h2>
				<p class="hint-text">Create your account. It's just a matter of minute</p>
				...
				<div class="form-group">
					<button type="submit" class="btn btn-success btn-lg btn-block">SignUp  Now</button>
				</div>
			</form>
			<div class="text-center">
				Already have an account? <a href="#">Just Log In</a>
			</div>
		</div>
	</div>
</body>
